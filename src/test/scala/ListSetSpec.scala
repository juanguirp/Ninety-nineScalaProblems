...
class ListSetSpec extends fixture.FlatSpec with GivenWhenThen {
  ...
  "S12: decodeList method" should "return a list from {A*, (N, A=*} to {A}" in { f =>
    ...
    When("it is decoded")
    val decodedList1 = f.solution.decodeList(encodedList)
    val decodedList2 = f.solution.decodeList2(encodedList)

    Then("the result is a list with consecutive duplicates elements")
    assert(decodedList1 === List('a, 'a, 'a, 'a, 'b, 'c, 'c, 'a, 'a, 'd, 'e, 'e, 'e, 'e))
    // Using built-in solution.
    assert(decodedList2 === List('a, 'a, 'a, 'a, 'b, 'c, 'c, 'a, 'a, 'd, 'e, 'e, 'e, 'e))
  }

  "S13: method" should "return a " is (pending)
  "S14: method" should "return a " is (pending)
  "S15: method" should "return a " is (pending)
  "S16: method" should "return a " is (pending)
  "S17: method" should "return a " is (pending)
  "S18: method" should "return a " is (pending)
  "S19: method" should "return a " is (pending)
  "S20: method" should "return a " is (pending)
  "S21: method" should "return a " is (pending)
  "S22: method" should "return a " is (pending)
  "S23: method" should "return a " is (pending)
  "S24: method" should "return a " is (pending)
  "S25: method" should "return a " is (pending)
  "S26: method" should "return a " is (pending)
  "S27: method" should "return a " is (pending)
  "S28: method" should "return a " is (pending)
